    ...
    <div className="min-h-screen bg-gradient-to-b from-[#05060b] via-[#090b11] to-[#040508] py-16 px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-4">
        ...
        <h1 className="text-4xl sm:text-6xl font-black font-display tracking-tight text-white leading-tight">
          ...
          <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Digital Commerce.</span>
        </h1>
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="glass border border-slate-800/40 rounded-3xl p-8 space-y-4 shadow-lg shadow-black/10">
          <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-2xl w-fit text-blue-400">
            <Target className="w-6 h-6" />
          </div>
          <h2 className="text-2xl font-black font-display text-white">Our Mission</h2>
        ...
        <div className="glass border border-slate-800/40 rounded-3xl p-8 space-y-4 shadow-lg shadow-black/10">
          ...
          <h2 className="text-2xl font-black font-display text-white">Our Vision</h2>
          <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <h2 className="text-3xl font-black font-display text-white text-center">Core Company Values</h2>
